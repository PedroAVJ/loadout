...
use Claude Fable for the first implementation pass before directly editing
those UI files.

## Contract

1. Claude Fable owns the first browser-visible implementation pass.
...
6. If Fable cannot run, say so before editing UI. A fallback model or
...
this skill. Keep `--model fable` explicit for browser-visible implementation.
